...
function createAnimatedStyle(inputStyle) {
  ...
  for (var key in style) {
    var value = style[key];
    key === "transform" ? animatedStyles[key] = new import_AnimatedTransform.default(value) : _instanceof(value, import_AnimatedNode.default) ? animatedStyles[key] = value : value && !Array.isArray(value) && (typeof value > "u" ? "undefined" : _type_of(value)) === "object" && (animatedStyles[key] = createAnimatedStyle(value));
  }
  ...
  return _create_class(AnimatedStyle2, [
    {
      ...
      value: function(style) {
        ...
        for (var key in style) {
          var value = style[key];
          _instanceof(value, import_AnimatedNode.default) ? value.__isNative || (updatedStyle[key] = value.__getValue()) : value && !Array.isArray(value) && (typeof value > "u" ? "undefined" : _type_of(value)) === "object" ? updatedStyle[key] = this._walkStyleAndGetValues(value) : updatedStyle[key] = value;
        }
        return updatedStyle;
      }
    },
    ...
    },
    {
      ...
      value: function(style) {
        ...
        for (var key in style) {
          var value = style[key];
          _instanceof(value, import_AnimatedNode.default) ? updatedStyle[key] = value.__getAnimatedValue() : value && !Array.isArray(value) && (typeof value > "u" ? "undefined" : _type_of(value)) === "object" && (updatedStyle[key] = this._walkStyleAndGetAnimatedValues(value));
        }
        return updatedStyle;
      }
    },
