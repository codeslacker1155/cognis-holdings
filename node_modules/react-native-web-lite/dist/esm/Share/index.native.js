  ...
  return _create_class(Share2, null, [
    {
      ...
      value: function(content) {
        ...
        return invariant((typeof content > "u" ? "undefined" : _type_of(content)) === "object" && content !== null, "Content to share must be a valid object"), invariant(typeof content.url == "string" || typeof content.message == "string", "At least one of URL and message is required"), invariant((typeof options > "u" ? "undefined" : _type_of(options)) === "object" && options !== null, "Options must be a valid object"), invariant(!content.title || typeof content.title == "string", "Invalid title: title should be a string."), window.navigator.share !== void 0 ? window.navigator.share({
          title: content.title,
