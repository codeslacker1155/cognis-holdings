...
function createAnimations(animations) {
  return {
    ...
    useAnimations: (animationProps) => {
      ...
      if (Array.isArray(props.animation)) {
        ...
        if (config && typeof config == "object")
          for (const key in config) {
            ...
            hasClonedTransition || (transition = Object.apply({}, transition), hasClonedTransition = !0), typeof val == "string" ? transition[key] = animations[val] : transition[key] = val;
          }
      }
      const motiProps = {
      ...
      }, moti = (0, import_moti.useMotify)(motiProps);
