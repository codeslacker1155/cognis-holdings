...
var VIEWPORT_NAME = "ToastViewport", VIEWPORT_DEFAULT_HOTKEY = [
    ...
    children: [
      ...
      */
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ToastProvider.Collection.Slot, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastViewportFrame, _object_spread_props(_object_spread({
  ...
  return portalToRoot ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ToastPortal.ToastPortal, _object_spread_props(_object_spread({}, typeof zIndex == "number" ? {
    zIndex
  } : {}), {
    children: contents
  })) : contents;
...
var FOCUS_PROXY_NAME = "ToastFocusProxy", FocusProxy = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var __scopeToast = props.__scopeToast, onFocusFromOutsideViewport = props.onFocusFromOutsideViewport, viewportName = props.viewportName, proxyProps = _object_without_properties(props, [
    ...
    "viewportName"
  ]), context = (0, import_ToastProvider.useToastProviderContext)(__scopeToast), viewport = context.viewports[viewportName];
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_visually_hidden.VisuallyHidden, _object_spread_props(_object_spread({
    "aria-hidden": !0,
    tabIndex: 0
  }, proxyProps), {
    ref: forwardedRef,
