...
function ReprogapateToastProvider(props) {
  ...
  return /* @__PURE__ */ jsx(Collection.Provider, { __scopeCollection: TOAST_CONTEXT, children: /* @__PURE__ */ jsx(ToastProviderProvider, { ...context, children: /* @__PURE__ */ jsx(ToastImperativeProvider, { options: context.options, children }) }) });
}
